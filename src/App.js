...
function App() {
	...
	return (
		<>
			...
			<Layout title="Rules" urlBg={Bg1} colorBG={color}>
				<span>
			...
			<Layout title="Full Rules" urlBg={Bg3}>
				...
				<span>
					To do this, the player must capture cards by placing a card adjacent
					to an opponent's card whereupon the 'ranks' of the sides where the two
